        ...
        >
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-white/70 text-[11px]">{t('hub.greeting', { greeting: getGreeting(), name: profile?.pet_name || t('hub.friend') })}</p>
                <p className="text-white font-bold text-sm">{t('hub.whatAdventure')}</p>
              </div>
            </div>
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <button
                ...
                className="relative w-8 h-8 rounded-full flex items-center justify-center border-0 cursor-pointer"
                style={{ background: 'rgba(255,255,255,0.15)' }}
              >
          ...
          <div
            ...
            className="flex items-center gap-2.5 rounded-2xl px-3.5 py-2.5 cursor-pointer"
            style={{ background: 'rgba(255,255,255,0.15)' }}
          >
